...
@Component({
    ...
    styleUrls: ['./truckersignup.component.scss'],
...
export class TruckersignupComponent implements OnInit {
 ...
 //userid validation
        ...
        //license validation
        licenseid: new FormControl('', [Validators.required, Validators.minLength(1), Validators.maxLength(32)]),
    ...
    get confirmpassword() {
     ...
     get licenseid() {
        return this.myform.get("licenseid");
    }
}
